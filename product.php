...
<style>
	...
	<br>
	<h2>คลังสินค้าทั้งหมด</h2><br>

	<div class="container">
<?php
$sql="select * from tb_product inner join tb_member on tb_product.member_id=tb_member.member_id";
$result=$db->query($sql);
...
<!-- <a href="?page=product&product_id=<?=$row['product_id'];?>">55</a>-->	
